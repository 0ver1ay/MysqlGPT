...
$db_connection_charset = 'utf8_general_ci';
...
if (!$error && !TESTMODE) {
    ...
    if (!$error) {
        $db_connection_charset = 'utf8'; // Установите нужную кодировку
        $mysqli->set_charset($db_connection_charset); // Устанавливаем кодировку соединения
    }
